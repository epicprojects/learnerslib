...
public class RNF {
    ...
    public static void main(String[] args) {
        ...
        String TrainQuery = "SELECT `id`,`Chromosome`,`Mutation_type`,`Tumer_genotype`,`Mutation`,`gene_name`,`Con_type`,`Cancer` FROM genes  ORDER BY RAND() LIMIT 600";
         String TestQuery = "SELECT `id`,`Chromosome`,`Mutation_type`,`Tumer_genotype`,`Mutation`,`gene_name`,`Con_type`,`Cancer` FROM genes  ORDER BY RAND() LIMIT 300";
 ...
 //============================================NRS       
        ...
        DataSet NRS = main.NeighbourhoodRoughSets(Train, 10, "Breast Cancer (JHU, US)"); //Neibourhood Rough Sets   
